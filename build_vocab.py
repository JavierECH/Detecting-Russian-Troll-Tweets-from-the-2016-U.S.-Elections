...
if __name__ == '__main__':
	...
	words = Counter()
	size_train_tweets = update_vocab(os.path.join(args.data_dir, 'train/tweets.txt'), words)
	size_dev_tweets = update_vocab(os.path.join(args.data_dir, 'val/tweets.txt'), words)
	size_test_tweets = update_vocab(os.path.join(args.data_dir, 'test/tweets.txt'), words)
	print("- done.")
	...
	sizes = {
		'train_size': size_train_tweets,
		'dev_size': size_dev_tweets,
		'test_size': size_test_tweets,
